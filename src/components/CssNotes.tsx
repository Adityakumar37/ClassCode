...
const CssNotes = () => {
    const [selectedTopicId, setSelectedTopicId] = useState<string | null>("what-is-css");
    const [completedTopics, setCompletedTopics] = useState<string[]>([]);
    const [isSidebarOpen, setIsSidebarOpen] = useState(false);

    const allTopics = getAllTopics(cssNotes);
    const currentTopic = selectedTopicId ? getTopicById(selectedTopicId, cssNotes) : null;
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">
                                <span className="gradient-text">CSS</span> Basics
                            </h1>
