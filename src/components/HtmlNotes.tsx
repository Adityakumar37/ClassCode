...
const HtmlNotes = () => {
    const [selectedTopicId, setSelectedTopicId] = useState<string | null>("what-is-html");
    const [completedTopics, setCompletedTopics] = useState<string[]>([]);
    const [isSidebarOpen, setIsSidebarOpen] = useState(false);

    const allTopics = getAllTopics(htmlNotes);
    const currentTopic = selectedTopicId ? getTopicById(selectedTopicId, htmlNotes) : null;
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold">
                                <span className="gradient-text">HTML</span> Basics
                            </h1>
